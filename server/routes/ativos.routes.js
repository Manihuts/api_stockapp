...
router.get("/fetch/evolution/balance/:id", fetchEvolucaoSaldo);             // Busca a evolução do saldo de um usuário
router.get("/fetch/evolution/invested/:id", fetchEvolucaoValorInvestido);   // Busca a evolução do valor investido de um usuário
